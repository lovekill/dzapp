...
import com.engine.dzapp.view.GestureLockView.Mode ;
		...
		case MotionEvent.ACTION_UP:
			...
			if (mOnGestureLockViewListener != null && mChoose.size() > 0)
			{
				if(!isSetting) {
					...
					mOnGestureLockViewListener.onSetingEnd(mChoose);
				}
			}
 ...
 */
	...
	public interface OnGestureLockViewListener
	{
		...
		public void onSetingEnd(List<Integer> password) ;
	}
}
